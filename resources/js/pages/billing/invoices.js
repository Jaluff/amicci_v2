...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const table = $(tableEl).DataTable({
        ...
        columns: [
            ...
            { data: "fecha_cobro",    name: "fecha_cobro", className: "dt-left dt-head-left dt-body-left text-left whitespace-nowrap" },
            { data: "numero",         name: "numero", className: "dt-left dt-head-left dt-body-left text-left font-bold text-indigo-600 dark:text-indigo-400 whitespace-nowrap" },
            { data: "party_name",     name: "party_name", orderable: false, searchable: false, className: "dt-left dt-head-left dt-body-left text-left !whitespace-normal min-w-[150px]" },
            { data: "numero_recibo",  name: "numero_recibo", className: "dt-left dt-head-left dt-body-left text-left whitespace-nowrap" },
            { data: "shipments_count",name: "shipments_count", orderable: false, searchable: false, className: "dt-left dt-head-left dt-body-left text-left whitespace-nowrap" },
            { data: "total",          name: "total", className: "dt-left dt-head-left dt-body-left text-left font-bold text-green-600 dark:text-green-400 whitespace-nowrap" },
            { data: "actions",        name: "actions", orderable: false, searchable: false, className: "dt-center dt-head-center dt-body-center text-center whitespace-nowrap" },
        ],
        order: [[0, "desc"]],
