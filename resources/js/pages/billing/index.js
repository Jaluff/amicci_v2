...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const table = $(tableEl).DataTable({
        ...
        columns: [
            { data: "selection",      name: "selection",      orderable: false, searchable: false, className: "text-center" },
            { data: "fecha",          name: "shipments.fecha", className: "text-left whitespace-nowrap" },
            { data: "fecha_entrega",  name: "shipments.fecha_entrega", className: "text-left whitespace-nowrap" },
            { data: "numero",         name: "shipments.numero", className: "text-left whitespace-nowrap" },
            { data: "sender_name",    name: "sender_name",    orderable: false, searchable: false, className: "text-left !whitespace-normal min-w-[150px]" },
            { data: "recipient_name", name: "recipient_name", orderable: false, searchable: false, className: "text-left !whitespace-normal min-w-[150px]" },
            { data: "invoice_badge",  name: "invoice_badge",  orderable: false, searchable: false, className: "text-center whitespace-nowrap" },
            { data: "cobrada",        name: "shipments.cobrada", className: "text-center whitespace-nowrap" },
            { data: "total",          name: "shipments.total", className: "text-left whitespace-nowrap font-bold text-indigo-600" },
            { data: "actions",        name: "actions",        orderable: false, searchable: false, className: "text-center whitespace-nowrap" },
        ],
