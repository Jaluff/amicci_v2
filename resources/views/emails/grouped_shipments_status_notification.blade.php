...
<head>
    ...
    <title>Actualización de tus Envíos</title>
</head>
                        ...
                        <td style="padding: 40px 30px; color: #2d3748;">
                            ...
                            <p style="margin-top: 0; margin-bottom: 24px; font-size: 15px; line-height: 1.6; color: #4a5568;">
                                @if($shipments->count() === 1)
                                    Te informamos que tu envío se encuentra en la siguiente etapa del proceso:
                                @else
                                    Te informamos que tus envíos se encuentran en la siguiente etapa del proceso:
                                @endif
                            </p>
                            ...
                            <!-- Details Table -->
                            <h3 style="font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em; color: #718096; margin-top: 0; margin-bottom: 12px; font-weight: 600;">Detalle de las Guías</h3>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; margin-bottom: 30px; font-size: 13px;">
                                <thead>
                                    <tr style="background-color: #f8fafc; border-bottom: 2px solid #edf2f7; text-align: left;">
                                        <th style="padding: 10px; color: #718096; font-weight: 600;">Nº Guía</th>
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-bottom: 1px solid #edf2f7;">
                                        <td style="padding: 10px; color: #dc8a18; font-weight: bold; white-space: nowrap;">
                                            #{{ $shipment->numero }}
                                        </td>
