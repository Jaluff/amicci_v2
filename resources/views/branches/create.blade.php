...
<div class="py-6">
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        <form action="{{ route('branches.store') }}" method="POST" class="space-y-4 max-w-lg">
            @csrf
            ...
            <div>
                ...
                <x-text-input name="name" type="text" value="{{ old('name') }}"
                    ...
                    placeholder="Casa Central BA" required />
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Ej: código 1 → guías AM-1-00000001</p>
            </div>
