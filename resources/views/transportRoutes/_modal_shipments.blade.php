<div id="shipments-modal"
    ...
    <div
        ...
        <div
            ...
            <strong>Nota:</strong> Solo se mostrarán las guías libres cuyo <strong>Origen y Destino</strong> coincidan
            con los seleccionados en el formulario de la ruta.
        </div>

        <div class="overflow-x-auto min-h-[300px]">
            <table class="w-full text-left border-collapse display responsive" id="available-shipments-table"
                data-url="{{ route('routes.available-shipments') }}" style="width:100%">
