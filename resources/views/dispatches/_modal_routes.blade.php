<div id="routes-modal"
    ...
    <div
        ...
        <div class="flex justify-between items-center mb-4 pb-2 border-b dark:border-gray-700">
            <h3 class="text-xl font-bold text-gray-900 dark:text-white">Seleccionar Rutas Disponibles</h3>
            <button type="button" class="text-gray-400 hover:text-gray-500 focus:outline-none btn-close-routes-modal">
        ...
        <div
            ...
            <strong>Nota:</strong> Solo se mostrarán las rutas con estado <strong>"Cargada"</strong> y sin despacho
            asignado.
        </div>

        <div class="overflow-x-auto min-h-[300px]">
            <table class="w-full text-left border-collapse display responsive" id="available-routes-table"
                data-url="{{ route('dispatches.available-routes') }}" style="width:100%">
                <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="p-2 font-semibold text-gray-800 dark:text-gray-200 text-right">Guías</th>
                    </tr>
                </thead>
            </table>
        </div>
        ...
        <div class="flex justify-end gap-3 mt-6 pt-4 border-t dark:border-gray-700">
            <button type="button"
                class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded transition btn-close-routes-modal">Cancelar</button>
            <button type="button"
                class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded shadow transition btn-confirm-routes">
                Agregar Seleccionadas (<span id="selected-routes-count">0</span>)
            </button>
        </div>
    </div>
</div>