                ...
                <div class="mb-4 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 items-end">
                        <div>
                            ...
                            <select id="filter_company_id" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 rounded-md shadow-sm text-sm" disabled>
                                <option value="{{ $invoice->company_id }}">{{ $invoice->company?->name }}</option>
                            </select>
                        </div>
                        <div>
