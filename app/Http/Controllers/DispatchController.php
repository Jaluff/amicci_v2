...
class DispatchController extends Controller
{
    ...
    public function create(): View
    {
        ...
        $ubicaciones = \App\Models\Ubicacion::all(['id', 'nombre']);
        ...
        return view('dispatches.create', compact('drivers', 'ubicaciones', 'branches'));
    }
    ...
    public function edit(Dispatch $dispatch): View
    {
        ...
        return view('dispatches.edit', compact('dispatch', 'drivers', 'ubicaciones', 'branches'));
    }
    ...
    public function destroy(Dispatch $dispatch)
    {
        ...
        if ($dispatch->routes()->count() > 0) {
            return redirect()->route('dispatches.index')->with('error', 'No se puede eliminar un despacho que tiene rutas asignadas.');
        }
